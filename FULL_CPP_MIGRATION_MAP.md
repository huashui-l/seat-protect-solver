...
| restricted/protected master | Python HiGHS stages | native protected component MIP and Rich restricted MIP/local branching functions match frozen Python on complete legal entry contexts; restricted production integration remains pending; independent RR master is still a different production consumer | PARTIAL_CPP | yes | ACTIVE, semantics differ |
