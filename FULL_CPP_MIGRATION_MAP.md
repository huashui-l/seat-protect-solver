...
| multi-group rebuild/LNS | conflict LNS and pattern MIPs | native LNS eligibility, frozen infant scoring, ordinary DP and special permutation matching differential passed; candidate generation, local master and search remain pending | PARTIAL_CPP | master only | ACTIVE |
